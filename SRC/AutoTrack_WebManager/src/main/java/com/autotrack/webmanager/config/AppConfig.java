...
public class AppConfig {
	...
	public SessionFactory sessionFactory(){
		...
		hibernateProperties.setProperty("hibernate.ejb.naming_strategy", "org.hibernate.cfg.EJB3NamingStrategy");
		hibernateProperties.setProperty("hibernate.bytecode.provider", "javassist");
